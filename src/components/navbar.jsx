...
import bugsfreetvlogo from "../images/bugsfreetvlogo.png";
  ...
  return (
    <div
     ...
     <h1 className="w-1/3"><img src={bugsfreetv} alt="bugsfreetv" /></h1>
      <h1 className="font-medium text-lg text-center cursor-default p-3 w-1/3"><img src={bugsfreetvlogo} alt="bugsfreetvlogo" /></h1>
